function [GraphAreaAv, GraphAreaSD, MathArea,Loops] = HysteresisCalc(dataFile, LostStiffness)
%% Import the data
...
%         maxLoc = maxLoc(zer,1);
    ...
    clearvars numLoops minCounter maxCounter totalSize minLoc maxLoc firstMin lastMin...
